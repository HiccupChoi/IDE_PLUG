...
public class RequestRunnable implements Runnable {
    ...
    private static final String PARAM_KEY_APP_KEY = "key";
    private static final String PARAM_KEY_TYPE = "type";
    private static final String PARAM_KEY_SALT = "doctype";
    private static final String PARAM_KEY_SIGN = "version";
    ...
    private void showPopupBalloon(final String result) {
        ApplicationManager.getApplication().invokeLater(new Runnable() {
            public void run() {
                ...
                factory.createHtmlTextBalloonBuilder(result, null, new JBColor(new Color(91, 90, 78), new Color(39, 40, 34)), null)
                        .setFadeoutTime(5000)
                        .createBalloon()
    ...
    private URI createTranslationURI(String query) throws URISyntaxException {
        ...
        builder.setScheme("http")
                .setHost(HOST)
                .setPath(PATH)
                .addParameter(PARAM_KEY_FROM, "Skykai521")
                .addParameter(PARAM_KEY_APP_KEY, "977124034")
                .addParameter(PARAM_KEY_TYPE, "data")
                .addParameter(PARAM_KEY_SALT, "json")
                .addParameter(PARAM_KEY_SIGN, "1.1")
